...
class ProjectCreationDialogue extends StatefulWidget {
  @override
  _ProjectCreationDialogueState createState() =>
      _ProjectCreationDialogueState();
}

class _ProjectCreationDialogueState extends State<ProjectCreationDialogue>
    with TickerProviderStateMixin {
  final _bloc = ProjectCreationBloc();
  final _tabs = <Widget>[
    Tab(text: 'Информация'),
